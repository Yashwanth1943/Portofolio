...
const SideRays = ({
  ...
  // Start visible immediately — fixed/fullscreen elements are always in viewport.
  // IntersectionObserver still pauses the loop when the element leaves the DOM.
  const [isVisible, setIsVisible] = useState(true);
  const observerRef = useRef(null);

  /* ── Visibility observer: pause WebGL when element leaves viewport ── */
  useEffect(() => {
